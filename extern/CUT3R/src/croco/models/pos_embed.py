...
class RoPE2D(torch.nn.Module):
    ...
    def forward(self, tokens, positions):
        ...
        output:
            * tokens after applying RoPE2D (batch_size x nheads x ntokens x dim)
        """
        assert (
            tokens.size(3) % 2 == 0
...
if os.environ.get("VMEM_USE_CUROPE", "0") == "1":
    try:
        ...
        print("Warning: cuRoPE2D requested but unavailable; using PyTorch RoPE2D")
